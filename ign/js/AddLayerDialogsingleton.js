...
var AddLayerDialog = {
    ...
    singleton: {
        ...
        showModal: function(map){
            ...
            //añadimos un conjunto de pestañas, en cada pestaña habrñ un formato
            ...
            //en la version profesional con ocultarlos serña suficiente
        ...
        connectToServerForm_onButtonClick: function(name, command){
            ...
            if(this.connectToServerForm.validateItem('urlCombo'))
            {
                ...
                dhtmlxAjax.get(request,function(loader){
                    ...
                    {   
                        AddLayerDialog.singleton.addLayerStatusBar.setText('Conexiñn establecida, procesando respuesta');
